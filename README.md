...
<div class="bubble-section">
  <img class="bubble-img" src="./images/bg-pattern-card.svg" alt="Bubble Pattern">
  <img class="profile-img" src="./images/image-victor.jpg" alt="Profile Picture of Victor Crest">
</div>
```
```css
.proud-of-this-css {
